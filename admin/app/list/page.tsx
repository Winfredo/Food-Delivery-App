                ...
                >
                  ...
                  <div className="md:hidden space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 border border-gray-900 text-gray-900 hover:bg-gray-100 active:scale-95 px-4 py-2 text-sm transition-all duration-150"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => deleteFood(food._id)}
                        className="flex-1 bg-gray-900 hover:bg-gray-800 active:scale-95 active:bg-gray-700 text-white px-4 py-2 text-sm transition-all duration-150"
                      >
                        Delete
                      </button>
                    </div>
                  ...
                  <div className="hidden md:grid grid-cols-12 gap-4 items-center text-sm">
                    ...
                    <div className="col-span-3 flex gap-2">
                      <button
                        onClick={() => openEditModal(food)}
                        className="border border-gray-900 text-gray-900 hover:bg-gray-100 active:scale-95 px-4 py-2 text-sm transition-all duration-150"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => deleteFood(food._id)}
                        className="bg-gray-900 hover:bg-gray-800 active:scale-95 active:bg-gray-700 text-white px-4 py-2 text-sm transition-all duration-150"
                      >
                        Delete
                      </button>
                    </div>
        ...
        {list.length > 0 && (
          <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 border-t border-gray-200 pt-4">
            <span className="text-sm text-gray-500">
              ...
              {Math.min(startIndex + ITEMS_PER_PAGE, list.length)} of{" "}
              {list.length} items
            </span>
            {totalPages > 1 && (
