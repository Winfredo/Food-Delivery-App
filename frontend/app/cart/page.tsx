      ...
      <div className="cart-items">
        ...
        {foodList.map((item, index) => {
          if (cartItems[item._id] > 0) {
            return (
              <div key={index}>
                <div className=" my-2.5 mx-0 text-black grid grid-cols-[1fr_1.5fr_1fr_1fr_1fr_0.5fr] items-center text-[max(1vw,12px)]">
                  ...
                  <button
                    ...
                    className="bg-[#FF6347] text-white p-1 rounded-[50px] cursor-pointer"
                  >
                    Remove
                  </button>
                </div>
      ...
      <div className="mt-20 flex md:flex-row flex-col-reverse justify-between gap-[max(12vw,20px)]">
        <div className="cart-total flex-1 flex flex-col gap-5">
          ...
          <button
            ...
            className="px-0 rounded-lg py-3.5 border-none text-white bg-[#FF6347] w-[max(15vw,200px)] cursor-pointer active:scale-95 active:bg-[#e5533d] transition-all duration-150"
          >
            Proceed to Checkout
          </button>{" "}
        </div>
        <div className="cart-promo-code justify-start md:justify-end flex-1">
          <div>
            ...
            <div className=" mt-2.5 flex justify-between align-center bg-[#eaeaea] rounded-sm">
              ...
              />
              <button className="w-[max(10vw,150px)] py-3 px-1.25 bg-black text-white border-none rounded-sm">
                submit
              </button>
            </div>
          </div>
