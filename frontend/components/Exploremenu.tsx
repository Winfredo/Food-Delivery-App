...
const Exploremenu = ({ category, setCategory }: Props) => {
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="text-[15px] max-w-full lg:max-w-[45%]">
        Choose from a diverse menu featuring a delectable array of dishes. Our
        mission is to satisfy your cravings and elevate your dining experience,
        one delicious meal at a time.
      </p>
      <div className="flex justify-between items-center my-5 mx-0 overflow-x-scroll scrollbar-hide">
        {menuList.map((menu, index) => (
          ...
          >
            ...
            />
            <h3 className="mt-2 text-[#747474] font-semibold text-[14px] lg:text-[1.2vw] cursor-pointer">
              {menu.name}
            </h3>
          </div>
        ))}
