...
<li 
      ...
      >
        ...
        <div className='flex items-center gap-10 text-white'>
          <Image src="/assets/search_icon.png" alt="search icon" width={20} height={20} />
         <Image src="/assets/basket_icon.png" alt="basket icon" width={20} height={20} />
        <button className='border border-[#FF6347] hover:bg-[#fff4f2] cursor-pointer text-black py-2 px-4 rounded-full'>sign in</button>
        </div>
      </div>
    </div>
  )
